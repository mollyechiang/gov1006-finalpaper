...
```{r table 1 made, results="asis"}

library(stargazer)

stargazer(mod_1, mod_2, mod_3, mod_4, mod_5, mod_6, mod_7, mod_8, mod_9, mod_10, mod_11, mod_12, type = "latex", add.lines = list(c("Fixed effects?", "Y", "Y”, Y", "Y", "Y", "Y")), title = "Effects of Wind Turbines on Incumbent Party Vote Share in Precincts")
